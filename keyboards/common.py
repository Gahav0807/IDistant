...
main_menu_builder.button(text="Трейд")
...
repair_menu_builder.button(text="Apple⚙️")
repair_menu_builder.button(text="Android⚙️")
...
trade_menu_builder = ReplyKeyboardBuilder()
trade_menu_builder.button(text="Apple🔄️")
trade_menu = trade_menu_builder.as_markup(resize_key=True)